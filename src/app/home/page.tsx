...
// const DarkThemeHomepage: React.FC<HomepageProps> = () => {
//     const daoName='Solana DAO';
//     const daoDescription='Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus odio non perferendis vitae et dolorem ipsam inventore distinctio atque eligendi.'
//     const proposals = [
//       {
...
//       {/* Banner Section */}
//       <div className="relative w-full h-72 overflow-hidden rounded-b-lg shadow-lg">
//         <img src="/meta.png" alt="DAO Banner" className="object-cover w-full h-full" />
//         <div className="absolute inset-0 bg-black opacity-50"></div>
//         <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
//           <h1 className="text-5xl font-bold">{daoName}</h1>
//           <p className="text-xl mt-2">{daoDescription}</p>
//         </div>
//       </div>

//       {/* Proposals Section */}
//       <div className="container max-w-4xl mx-auto mt-12 px-4">
//         <h2 className="text-3xl font-semibold text-gray-100 mb-6">Proposals</h2>
  ...
  return (
    ...
    <section className="w-full bg-[#121212] text-gray-100">
      ...
      <div className="relative w-full h-48 overflow-hidden rounded-b-lg shadow-lg">
        ...
        {/* <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center"> */}
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
          <h1 className="text-5xl font-bold text-neon-pink">{daoName}</h1>
          <p className="text-xl mt-2 text-neon-cyan">{daoDescription}</p>
        </div>
      </div>

      {/* Proposals Section */}
      <div className="container max-w-4xl mx-auto mt-12 px-4">
        <h2 className="text-3xl font-semibold text-neon-pink mb-6">Proposals</h2>
        <div className="space-y-6">
          {proposals.map((proposal, index) => (
            <div key={index} className="p-6 bg-gray-800 rounded-lg shadow-lg border hover:border-2 cursor-pointer border-gray-500 hover:bg-gray-700 transition-all duration-300">
              <h3 className="text-2xl font-bold text-violet-200">{proposal.name}</h3>
